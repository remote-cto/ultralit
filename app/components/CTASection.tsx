  ...
  return (
    <section className="relative bg-gradient-to-br from-amber-300 via-amber-400 to-yellow-200 py-8 overflow-hidden">
      ...
      <div className="relative max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 text-center">
        ...
        <FadeInUp delay={600}>
          <button className="group bg-gradient-to-r from-amber-400 to-amber-500 hover:from-amber-500 hover:to-amber-600 text-slate-900 px-6 lg:px-12 py-5 rounded-full font-bold  transition-all duration-300 hover:shadow-2xl hover:scale-105 flex items-center gap-4 mx-auto shadow-xl">
        ...
        <FadeInUp delay={800}>
          <div className="mt-8 text-slate-800">
            <p className="text-sm font-medium">
              Join 10,000+ professionals already accelerating their careers
            </p>
